...
router.post('/signup', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { error: walletError } = yield supabase_1.default.from('wallets').insert([{
            user_id: user.id,
...
router.post('/goals/custom', auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { data: wallet, error: walletError } = yield supabase_1.default
        .from('wallets')
        .select('base_purse')
        .eq('user_id', user_id)
        .single();
    ...
    res.json(Object.assign(Object.assign({}, data === null || data === void 0 ? void 0 : data[0]), { message: `Goal created successfully! ${pledge_amount} RDM pledged and locked.` }));
}));
...
router.get('/goals', auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user_id = req.user.id;
    const { data: goals, error } = yield supabase_1.default
        .from('goals')
        .select('*')
    ...
    const { data: claimedGoals } = yield supabase_1.default
        .from('user_goals')
        .select('goal_id')
        .eq('user_id', user_id);
    const claimedGoalIds = new Set((claimedGoals === null || claimedGoals === void 0 ? void 0 : claimedGoals.map(claim => claim.goal_id)) || []);
    // Add claim status to each goal
    const goalsWithClaimStatus = goals === null || goals === void 0 ? void 0 : goals.map(goal => (Object.assign(Object.assign({}, goal), { is_claimed: claimedGoalIds.has(goal.id) })));
...
router.get('/wallet/debug', auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.user.id;
...
router.get('/wallet/balance', auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user_id = req.user.id;
    const { data, error } = yield supabase_1.default
        .from('wallets')
...
router.post('/goals/reflect', auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { data: goal, error: goalError } = yield supabase_1.default
            .from('goals')
            .select('*')
            .eq('id', goal_id)
            .single();
        if (goalError || !goal) {
            ...
            return res.status(400).json({ error: `Goal not found: ${(goalError === null || goalError === void 0 ? void 0 : goalError.message) || 'Unknown error'}` });
        }
        // Check if user has already reflected on this goal
        const { data: existingReflection } = yield supabase_1.default
            .from('user_goals')
            .select('*')
            .eq('user_id', user_id)
            .eq('goal_id', goal_id);
        ...
        const { error: reflectionError } = yield supabase_1.default
            .from('user_goals')
            .insert([{
                user_id,
                goal_id,
        ...
        if (walletError || !wallet) {
            ...
            return res.status(400).json({ error: `Wallet not found: ${(walletError === null || walletError === void 0 ? void 0 : walletError.message) || 'Unknown error'}` });
        }
...
router.post('/wallet/transfer', auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (walletErr || !wallets) {
            return res.status(400).json({ error: `Wallet not found: ${(walletErr === null || walletErr === void 0 ? void 0 : walletErr.message) || 'Unknown error'}` });
        }
...
router.get('/charity/organizations', (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { data, error } = yield supabase_1.default
...
router.get('/charity/preview', auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user.id;
        ...
        const { data: charities, error: charityError } = yield supabase_1.default
            .from('charity_organizations')
            .select('*')
            .eq('is_active', true)
            .order('allocation_percentage', { ascending: false });
        ...
        const preview = charities.map(charity => (Object.assign(Object.assign({}, charity), { allocated_amount: Math.floor((charityPurseBalance * charity.allocation_percentage) / 100) })));
        res.json({
...
router.post('/charity/distribute', auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user.id;
        // Get user's charity purse balance
        const { data: wallet, error: walletError } = yield supabase_1.default
        ...
        const { data: distribution, error: distError } = yield supabase_1.default
        ...
        const { error: detailsError } = yield supabase_1.default
...
router.get('/charity/history', auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user.id;
        const { data, error } = yield supabase_1.default
            .from('charity_distributions')
...
router.post('/charity/distribute-selected', auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user.id;
        ...
        const { data: organizations, error: orgError } = yield supabase_1.default
            .from('charity_organizations')
            .select('*')
            .in('id', orgIds)
            .eq('is_active', true);
...
router.post('/charity/donate', auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user.id;
        ...
        const { data: donation, error: donationError } = yield supabase_1.default
            .from('charity_distributions')
            .insert([{
                user_id: userId,
        ...
        if (donationError || !donation) {
            return res.status(400).json({ error: `Failed to create donation record: ${(donationError === null || donationError === void 0 ? void 0 : donationError.message) || 'Unknown error'}` });
        }
        // Create donation detail record
        const { error: detailError } = yield supabase_1.default
            .from('charity_distribution_details')
            .insert([{
...
router.post('/charity/seed', (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const charityOrgs = [
            {
...
router.get('/wallet/transactions', auth_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user_id = req.user.id;
    ...
    try {
        ...
        const { data: allTransactions, error: allError } = yield supabase_1.default
            .from('transactions')
            .select('*')
            .limit(5);
        if (allError) {
        ...
        const { data: transactions, error } = yield supabase_1.default
            .from('transactions')
            .select('*')
        ...
        console.log('📊 Found transactions:', (transactions === null || transactions === void 0 ? void 0 : transactions.length) || 0);
        // Format the transactions for the frontend
        const formattedTransactions = (transactions === null || transactions === void 0 ? void 0 : transactions.map(transaction => ({
            id: transaction.id,
